        ...
        >
          <Box>
            ...
            <Box mt="1rem" align={"left"}>
              ...
              >
                BƏYƏNDİYİNİZİ ƏLAVƏ EDİN <AiFillHeart color="red" size={"20px"} />
              </Button>
            </Box>
          </Box>
          <hr />
          ...
          <Box mt={"5rem"} align={"left"} mx={"4"}>
            ...
            <UnorderedList spacing={"3"} my={"4"}>
              <ListItem fontSize={"md"} fontWeight={"semibold"}>
                Cins : {currentProducts.gender}{" "}
              </ListItem>
              <ListItem fontSize={"md"} fontWeight={"semibold"}>
                Rəng : {currentProducts.color}{" "}
              </ListItem>
              <ListItem fontSize={"md"} fontWeight={"semibold"}>
                Reytinq : {currentProducts.rating}{" "}
              </ListItem>
            </UnorderedList>
          </Box>
        </Box>
